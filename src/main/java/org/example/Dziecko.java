...
public class Dziecko extends Czlowiek{
    ...
    public Dziecko(String imie, int zebrane_owoce,int zjedzone_owoce, int max_pracy, int pozycja_x, int pozycja_y,int ile_przerw){
        super(imie, zebrane_owoce, max_pracy, pozycja_x, pozycja_y,ile_przerw);
    }
